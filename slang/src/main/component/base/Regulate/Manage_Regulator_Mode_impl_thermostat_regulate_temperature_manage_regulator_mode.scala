  ...
  def timeTriggered(api: Manage_Regulator_Mode_impl_Operational_Api): Unit = {
    Contract(
      Ensures(
        ...
        // guarantee MRM_COMPUTE_GUMBOTABLE
        //   (0,0)
        ((lastRegulatorMode == Isolette_Data_Model.Regulator_Mode.Init_Regulator_Mode) & (!((api.interface_failure.value || api.internal_failure.value) &&
        ...
        // guarantee MRM_COMPUTE_GUMBOTABLE
        //   (0,1)
        ((lastRegulatorMode == Isolette_Data_Model.Regulator_Mode.Normal_Regulator_Mode) & (!((api.interface_failure.value || api.internal_failure.value) &&
           api.current_tempWstatus.status != Isolette_Data_Model.ValueStatus.Valid))) -->: (api.regulator_mode == Isolette_Data_Model.Regulator_Mode.Normal_Regulator_Mode &&
          lastRegulatorMode == Isolette_Data_Model.Regulator_Mode.Normal_Regulator_Mode),
        // guarantee MRM_COMPUTE_GUMBOTABLE
        //   (1,1)
        ...
        // guarantee MRM_COMPUTE_GUMBOTABLE
        //   (0,2)
        ((lastRegulatorMode == Isolette_Data_Model.Regulator_Mode.Failed_Regulator_Mode) & (!((api.interface_failure.value || api.internal_failure.value) &&
           api.current_tempWstatus.status != Isolette_Data_Model.ValueStatus.Valid))) -->: (api.regulator_mode == Isolette_Data_Model.Regulator_Mode.Failed_Regulator_Mode &&
          lastRegulatorMode == Isolette_Data_Model.Regulator_Mode.Failed_Regulator_Mode),
        // guarantee MRM_COMPUTE_GUMBOTABLE
        //   (1,2)
