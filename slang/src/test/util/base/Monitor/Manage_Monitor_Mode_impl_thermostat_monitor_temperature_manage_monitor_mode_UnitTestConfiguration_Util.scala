    ...
    return (Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Compute_UnitTestConfiguration (
      ...
      genReplay = (c: Container, testName: String, r: GumboXResult.Type) => Some(
       st"""Replay Unit Test:
            ...
            |    val testVector = base.JSON.toMonitorManage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_PreState_Container_P(json).left
    ...
    return (Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_ComputewL_UnitTestConfiguration (
      ...
      genReplay = (c: Container, testName: String, r: GumboXResult.Type) => Some(
       st"""Replay Unit Test:
            ...
            |    val results = base.GumboXUtil.GumboXResult.$r
            |    val json = st${tq}${base.JSON.fromutilContainer(c, T)}${tq}.render
            |    val testVector = base.JSON.toMonitorManage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_PreState_Container_PS(json).left
