...
@msig trait Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_GumboX_TestHarness extends Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_TestApi {
  ...
  def testInitialiseCB(
    ...
    val lastCmd: Isolette_Data_Model.On_Off.Type = base.Monitor.Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface.lastCmd
    ...
    val postResult = base.Monitor.Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_GumboX.inititialize_IEP_Post(lastCmd, api_interface_failure, api_lower_alarm_temp, api_monitor_status, api_upper_alarm_temp)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    base.JSON.toMonitorManage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_PreState_Container(json) match {
  ...
  def testComputeCB(
    ...
    val In_lastCmd: Isolette_Data_Model.On_Off.Type = base.Monitor.Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface.lastCmd
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = base.Monitor.Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_GumboX.compute_CEP_Post(In_lastCmd, lastCmd, api_current_tempWstatus, api_lower_alarm_tempWstatus, api_monitor_mode, api_upper_alarm_tempWstatus, api_interface_failure, api_lower_alarm_temp, api_monitor_status, api_upper_alarm_temp)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    base.JSON.toMonitorManage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_PreState_Container_PS(json) match {
  ...
  def testComputeCBwL(
    ...
    base.Monitor.Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface.lastCmd = In_lastCmd
