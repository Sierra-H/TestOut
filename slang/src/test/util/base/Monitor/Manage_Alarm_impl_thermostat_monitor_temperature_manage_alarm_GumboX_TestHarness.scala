...
@msig trait Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX_TestHarness extends Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_TestApi {
  ...
  def testInitialiseCB(
    ...
    val lastCmd: Isolette_Data_Model.On_Off.Type = base.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm.lastCmd
    ...
    val postResult = base.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX.inititialize_IEP_Post(lastCmd, api_alarm_control)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    base.JSON.toMonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_PreState_Container(json) match {
  ...
  def testComputeCB(
    ...
    val In_lastCmd: Isolette_Data_Model.On_Off.Type = base.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm.lastCmd

    // [CheckPre]: check/filter based on pre-condition.
    val CEP_Pre_Result: B = base.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX.compute_CEP_Pre (In_lastCmd, api_current_tempWstatus, api_lower_alarm_temp, api_monitor_mode, api_upper_alarm_temp)
    if (!CEP_Pre_Result) {
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = base.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_GumboX.compute_CEP_Post(In_lastCmd, lastCmd, api_current_tempWstatus, api_lower_alarm_temp, api_monitor_mode, api_upper_alarm_temp, api_alarm_control)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    base.JSON.toMonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_PreState_Container_PS(json) match {
  ...
  def testComputeCBwL(
    ...
    base.Monitor.Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm.lastCmd = In_lastCmd
