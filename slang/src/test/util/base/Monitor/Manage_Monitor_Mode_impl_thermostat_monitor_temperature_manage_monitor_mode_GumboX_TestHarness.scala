...
@msig trait Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_GumboX_TestHarness extends Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_TestApi {
  ...
  def testInitialiseCB(
    ...
    val lastMonitorMode: Isolette_Data_Model.Monitor_Mode.Type = base.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode.lastMonitorMode
    ...
    val postResult = base.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_GumboX.inititialize_IEP_Post(lastMonitorMode, api_monitor_mode)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    base.JSON.toMonitorManage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_PreState_Container(json) match {
  ...
  def testComputeCB(
    ...
    val In_lastMonitorMode: Isolette_Data_Model.Monitor_Mode.Type = base.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode.lastMonitorMode
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = base.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_GumboX.compute_CEP_Post(In_lastMonitorMode, lastMonitorMode, api_current_tempWstatus, api_interface_failure, api_internal_failure, api_monitor_mode)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    base.JSON.toMonitorManage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_PreState_Container_PS(json) match {
  ...
  def testComputeCBwL(
    ...
    base.Monitor.Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode.lastMonitorMode = In_lastMonitorMode
