...
@msig trait Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX_TestHarness extends Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_TestApi {
  ...
  def testInitialiseCB(
    ...
    val lastCmd: Isolette_Data_Model.On_Off.Type = base.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source.lastCmd
    ...
    val postResult = base.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX.inititialize_IEP_Post(lastCmd, api_heat_control)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    base.JSON.toRegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container(json) match {
  ...
  def testComputeCB(
    ...
    val In_lastCmd: Isolette_Data_Model.On_Off.Type = base.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source.lastCmd

    // [CheckPre]: check/filter based on pre-condition.
    val CEP_Pre_Result: B = base.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX.compute_CEP_Pre (In_lastCmd, api_current_tempWstatus, api_lower_desired_temp, api_regulator_mode, api_upper_desired_temp)
    if (!CEP_Pre_Result) {
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = base.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_GumboX.compute_CEP_Post(In_lastCmd, lastCmd, api_current_tempWstatus, api_lower_desired_temp, api_regulator_mode, api_upper_desired_temp, api_heat_control)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    base.JSON.toRegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_PS(json) match {
  ...
  def testComputeCBwL(
    ...
    base.Regulate.Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source.lastCmd = In_lastCmd
