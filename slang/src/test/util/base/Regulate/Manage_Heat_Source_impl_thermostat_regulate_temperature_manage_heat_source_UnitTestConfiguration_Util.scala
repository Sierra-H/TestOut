    ...
    return (Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Compute_UnitTestConfiguration (
      ...
      genReplay = (c: Container, testName: String, r: GumboXResult.Type) => Some(
       st"""Replay Unit Test:
            ...
            |    val testVector = base.JSON.toRegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_P(json).left
    ...
    return (Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_ComputewL_UnitTestConfiguration (
      ...
      genReplay = (c: Container, testName: String, r: GumboXResult.Type) => Some(
       st"""Replay Unit Test:
            ...
            |    val results = base.GumboXUtil.GumboXResult.$r
            |    val json = st${tq}${base.JSON.fromutilContainer(c, T)}${tq}.render
            |    val testVector = base.JSON.toRegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_PS(json).left
