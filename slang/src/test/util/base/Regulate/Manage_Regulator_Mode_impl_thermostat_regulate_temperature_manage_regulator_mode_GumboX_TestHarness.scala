...
@msig trait Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_GumboX_TestHarness extends Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_TestApi {
  ...
  def testInitialiseCB(
    ...
    val lastRegulatorMode: Isolette_Data_Model.Regulator_Mode.Type = base.Regulate.Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode.lastRegulatorMode
    ...
    val postResult = base.Regulate.Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_GumboX.inititialize_IEP_Post(lastRegulatorMode, api_regulator_mode)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    base.JSON.toRegulateManage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_PreState_Container(json) match {
  ...
  def testComputeCB(
    ...
    val In_lastRegulatorMode: Isolette_Data_Model.Regulator_Mode.Type = base.Regulate.Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode.lastRegulatorMode
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = base.Regulate.Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_GumboX.compute_CEP_Post(In_lastRegulatorMode, lastRegulatorMode, api_current_tempWstatus, api_interface_failure, api_internal_failure, api_regulator_mode)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    base.JSON.toRegulateManage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_PreState_Container_PS(json) match {
  ...
  def testComputeCBwL(
    ...
    base.Regulate.Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode.lastRegulatorMode = In_lastRegulatorMode
