    ...
    return (Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Compute_UnitTestConfiguration (
      ...
      genReplay = (c: Container, testName: String, r: GumboXResult.Type) => Some(
       st"""Replay Unit Test:
            ...
            |    val testVector = base.JSON.toRegulateManage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_PreState_Container_P(json).left
    ...
    return (Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_ComputewL_UnitTestConfiguration (
      ...
      genReplay = (c: Container, testName: String, r: GumboXResult.Type) => Some(
       st"""Replay Unit Test:
            ...
            |    val results = base.GumboXUtil.GumboXResult.$r
            |    val json = st${tq}${base.JSON.fromutilContainer(c, T)}${tq}.render
            |    val testVector = base.JSON.toRegulateManage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_PreState_Container_PS(json).left
...
@record class Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Compute_UnitTestConfiguration (
  ...
  override def test(c: Container): GumboXResult.Type = {
    return testComputeCBV(c.asInstanceOf[Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_PreState_Container])
  }
}
